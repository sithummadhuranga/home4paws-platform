...
namespace Home4Paws.API.Migrations
{
    ...
    [Migration("20251020131240_AddAdoptionMessaging")]
    partial class AddAdoptionMessaging
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Home4Paws.API.Models.Entities.AdoptionApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<bool>("HasYard")
                        .HasColumnType("boolean")
                        .HasColumnName("has_yard");

                    b.Property<int?>("HouseholdMembers")
                        .HasColumnType("integer")
                        .HasColumnName("household_members");
                    ...
                    b.ToTable("adoption_applications", "development");
                });

            modelBuilder.Entity("Home4Paws.API.Models.Entities.AdoptionFavorite", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("adoption_favorites", "development");
                });

            modelBuilder.Entity("Home4Paws.API.Models.Entities.AdoptionListing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<bool>("IsHouseTrained")
                        .HasColumnType("boolean")
                        .HasColumnName("is_house_trained");
                    ...
                    b.Property<string>("RehomingReason")
                        .HasColumnType("text")
                        .HasColumnName("rehoming_reason");
            ...
            modelBuilder.Entity("Home4Paws.API.Models.Entities.AdoptionApplication", b =>
                {
                    b.HasOne("Home4Paws.API.Models.Entities.User", "Applicant")
                        .WithMany()
